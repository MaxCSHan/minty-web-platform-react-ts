          ...
          >
            <div className={`flex my-2 w-full`}>
              ...
              <div className={`mx-2  w-5/6`}>
                <div className="h-14 w-5/6 px-4 py-3 max-w-md bg-gray-200 flex flex-wrap break-all  items-center justify-around border rounded-3xl">
                </div>
              </div>
            </div>
          </div>
  ...
  const chatroomTemplate = (
    <div className="flex-grow w-screen sm:w-160 bg-white  border flex flex-col">
      ...
      <div className="flex flex-col flex-grow px-4 overflow-y-scroll">
        {messages && messages.length > 0 ? messagesList : ""}
