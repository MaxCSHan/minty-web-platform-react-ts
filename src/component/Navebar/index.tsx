...
const Navbar = () => {
  ...
  return (
    <div className="fixed flex flex-col w-screen z-20 bg-white dark:bg-gray-800 dark:text-white ">
      <div className="h-14 flex items-center border-b justify-between">
        ...
        {usePathname() === "/" ? (
          ...
          <div className="ml-1 sm:ml-3 h-8 sm:h-10 w-60 border rounded-full flex items-center ">
            ...
            <input
              className="appearance-none w-full h-8 sm:h-10 border-t border-b rounded-r-full bg-gray-100 focus:bg-white outline-none transition duration-200 ease-in-out"
              type="text"
            ></input>
          </div>
        )}
          ...
          <div className="relative">
            ...
            >
              {notifications.map((note,index) => (
                <div className="h-12 border-b border-gray-50 flex items-center px-2" key={`notification_${index}`}>
